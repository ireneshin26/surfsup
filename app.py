...
#create a variable for Measurement and Station
...
#define welcome route and function
@app.route("/")
def welcome():
    return(
    '''
...
#define precipitation analysis route and function
...
#define stations route and function
...
#define temperature route and function
